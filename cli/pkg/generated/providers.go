...
func GetProviderDefinitions() (map[string]ProviderDefinition, error) {
	...
	// Gauss
	definitions["gauss"] = ProviderDefinition{
		ID:              "gauss",
		Name:            "Gauss",
		RequiredFields:  getFieldsByProvider("gauss", configFields, true),
		OptionalFields:  getFieldsByProvider("gauss", configFields, false),
		Models:          modelDefinitions["gauss"],
		DefaultModelID:  "",
		HasDynamicModels: false,
		SetupInstructions: `Configure Gauss API credentials`,
	}
